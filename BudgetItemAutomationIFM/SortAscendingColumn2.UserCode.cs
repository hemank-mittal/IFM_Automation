...
{
    public partial class SortAscendingColumn2
    {
        /// <summary>
        ...
        public void Mouse_Click_TableHeader(RepoItemInfo thtagInfo)
        {
        	...
        	var isAscending = Validate.AttributeEqual(thtagInfo, "aria-sort", "ascending", "Checking if sorting is set to 'ascending'.", option);
