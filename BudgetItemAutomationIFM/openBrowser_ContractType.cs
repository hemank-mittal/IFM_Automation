...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Website", "Opening web site 'https://app.ifm360.com/contracttypes' with browser specified by variable $browserName in normal mode.", new RecordItemIndex(1));
            Host.Current.OpenBrowser("https://app.ifm360.com/contracttypes", browserName, "", false, false, false, false, false, false, false, true);
            Delay.Milliseconds(0);
