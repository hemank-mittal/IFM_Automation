...
{
    public partial class createTaskTemplate
    {
        /// <summary>
        ...
        public void Mouse_Click_selectDropdown_FirstInstance(bool isProjectType)
        {
        	RepoItemInfo buttonToClick;
        	if (isProjectType)
        	{
        		buttonToClick = repo.ApplicationUnderTest.CdkOverlayContainer.selectDropdown_SecondInstanceInfo;
        	}
        	else
        	{
        		buttonToClick = repo.ApplicationUnderTest.CdkOverlayContainer.selectDropdown_FirstInstanceInfo;        		
        	}
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'spantagInfo' at Center.", buttonToClick);
