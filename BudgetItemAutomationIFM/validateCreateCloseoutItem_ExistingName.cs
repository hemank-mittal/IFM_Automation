...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The validateCreateCloseoutItem_ExistingName recording.
    /// </summary>
    [TestModule("fcc829d7-8148-4589-8452-1daa7a33cb91", ModuleType.Recording, 1)]
    public partial class validateCreateCloseoutItem_ExistingName : ITestModule
    {
        /// <summary>
        ...
        static validateCreateCloseoutItem_ExistingName instance = new validateCreateCloseoutItem_ExistingName();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public validateCreateCloseoutItem_ExistingName()
        {
            itemName = "";
            firstRecord = "";
            secondRecord = "";
        ...
        /// </summary>
        public static validateCreateCloseoutItem_ExistingName Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("3ee40233-c554-4379-8c65-ad47473dbb08")]
        ...
        /// </summary>
        [TestVariable("a9a0df5b-e973-43eb-9600-1c0469d97842")]
        ...
        /// </summary>
        [TestVariable("25bab0ba-25af-4b34-84ab-ad19a2fc5e16")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.Content1.closeoutCreateEditForm.ButtonTagCancel2' at Center.", repo.ApplicationUnderTest.Content1.closeoutCreateEditForm.ButtonTagCancel2Info, new RecordItemIndex(4));
            repo.ApplicationUnderTest.Content1.closeoutCreateEditForm.ButtonTagCancel2.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '' on item 'ApplicationUnderTest.searchBar_typeplaceholder'.", repo.ApplicationUnderTest.searchBar_typeplaceholderInfo, new RecordItemIndex(5));
            repo.ApplicationUnderTest.searchBar_typeplaceholder.Element.SetAttributeValue("TagValue", "");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.searchBar_typeplaceholder' at Center.", repo.ApplicationUnderTest.searchBar_typeplaceholderInfo, new RecordItemIndex(6));
            repo.ApplicationUnderTest.searchBar_typeplaceholder.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$itemName' with focus on 'ApplicationUnderTest.searchBar_typeplaceholder'.", repo.ApplicationUnderTest.searchBar_typeplaceholderInfo, new RecordItemIndex(7));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Ctrl+A' Press with focus on 'ApplicationUnderTest.searchBar_typeplaceholder'.", repo.ApplicationUnderTest.searchBar_typeplaceholderInfo, new RecordItemIndex(11));
            Keyboard.PrepareFocus(repo.ApplicationUnderTest.searchBar_typeplaceholder);
            Keyboard.Press(System.Windows.Forms.Keys.A | System.Windows.Forms.Keys.Control, 30, Keyboard.DefaultKeyPressTime, 1, true);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Back}' with focus on 'ApplicationUnderTest.searchBar_typeplaceholder'.", repo.ApplicationUnderTest.searchBar_typeplaceholderInfo, new RecordItemIndex(12));
