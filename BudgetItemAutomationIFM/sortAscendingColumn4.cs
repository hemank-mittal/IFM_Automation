...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (aria-sort='ascending') on item 'ApplicationUnderTest.TableHeader_Column4'.", repo.ApplicationUnderTest.TableHeader_Column4Info, new RecordItemIndex(1));
