...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'InnerText' from item 'ApplicationUnderTest.secondRow_FirstElement' and assigning its value to variable 'secondRecord'.", repo.ApplicationUnderTest.secondRow_FirstElementInfo, new RecordItemIndex(11));
